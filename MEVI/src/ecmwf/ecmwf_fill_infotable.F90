!==========================================================================================!
!==========================================================================================!
!  MEVI. Subroutine ecmwf_fill_infotable                                                   !
!                                                                                          !
...
!==========================================================================================!
!==========================================================================================!
subroutine ecmwf_fill_infotable(flnm)
   ...
   fileloop: do nf=1,nfiles
      ...
      if (ierr /= NF90_NOERR) then
         ...
         call fatal_error ('Error opening the file '//trim(fnames(nf))//'...'              &
                          ,'ecmwf_fill_infotable','ecmwf_fill_infotable.F90'               )
      end if
      ...
      call commio_ecmwf(ngrid,ntimes)
   ...
   return
end subroutine ecmwf_fill_infotable
!==========================================================================================!
!==========================================================================================!
...
!==========================================================================================!
!==========================================================================================!
subroutine ecmwf_load_var_table(nv,current_grid,varname,npointer,idim_type,ngrid,nvalues   &
                             ,rank,dims,stagger)
   ...
   if (ierr /= NF90_NOERR) then
      ...
      call fatal_error (                                                                   &
         ...
         ,'ecmwf_load_var_table','ecmwf_fill_infotable.F90')
   end if
   ...
   return
end subroutine ecmwf_load_var_table
