...
ifeq ($(KIND_COMP),Z)
   USE_INTERF=1
   F_OPTS= -FR -O0 -Vaxlib -traceback -assume byterecl
   C_OPTS= -O0 -Vaxlib -DLITTLE -traceback
   LOADER_OPTS= -FR -Vaxlib -O0 -traceback -assume byterecl
   C_LOADER_OPTS=-O0 -Vaxlib -v -traceback
   #---------------------------------------------------------------------------------------#
endif
#------------------------------------------------------------------------------------------#
