...
export LD_LIBRARY_PATH=/p1-sonny3/marcos/util/hdf4_intel/hdf4/lib:${LD_LIBRARY_PATH}
export LD_LIBRARY_PATH=/p1-sonny3/marcos/util/hdf4_intel/jpeg-6b/lib:${LD_LIBRARY_PATH}
export LD_LIBRARY_PATH=/p1-sonny3/marcos/util/hdf4_intel/szip/lib:${LD_LIBRARY_PATH}
export LD_LIBRARY_PATH=/p1-sonny3/marcos/util/hdf4_intel/zlib/lib:${LD_LIBRARY_PATH}
